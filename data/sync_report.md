# Sync Report - 2026-01-10 11:00

**13 new posts found, 7 posts with 13 offers added**

---

## 1. MMT vs Joveo vs DP world
...
|---------|------|-----|------|-------|----------|
| Moengage | SDE 1 | 2.6 | 31 | 31 | - |
| Dp World | SDE 1 | 2.6 | 35 | 35 | - |
| Joveo | SDE 1 | 2.6 | 30 | 30 | Remote |
| Mmt | SSE 1 | 2.6 | 24 | 24 | - |
| Another Similar Company | SSE 1 | 2.6 | 27 | 27 | - |

---

## 2. Oracle OCI | SMST/IC3 | Bangalore
...
| Company | Role | YoE | Base | Total | Location |
|---------|------|-----|------|-------|----------|
| Oracle | SDE | 4.5 | 38 | 63 | Bengaluru |

---

## 3. Bitgo | E2 Role | Compensation Details
...
| Company | Role | YoE | Base | Total | Location |
|---------|------|-----|------|-------|----------|
| Bitgo | E2 Role | 3.2 | 35 | 59.22 | - |

---

## 4. Zynga SSE1 Fullstack offer
...
## 5. Nike (SDE 1) vs Deloitte (Retention) | 3.5 YOE | India | Need Career Advice
...
| Deloitte | Consultant | 3.5 | - | 15 | - |

---

## 6. Amazon SDE2 vs Adobe MTS2
...
## 7. Smartsheet | SSE | Offer Evaluation

### Raw Content
```
Education: B.E from Tier 3 College

Years of experience: 5 years (Including intern)
Current Compensation: 29LPA (All fixed)

Offer Details:

Title/Level: Senior Software Engineer
Location: Hybrid, Bangalore
Base Salary: ₹37,00,000
Joining Bonus: ₹0
Year End Bonus: ₹3,50,000
Esops: NA
Total comp (Salary + Bonus): 40,50,000

Does anyone here have insights into the work culture and growth opportunities at Smartsheet?

Also, In my current org my growth has stalled due to some recent re-orgs, would love to jump ship. Is this resign-able offer? 
```
...
| Company | Role | YoE | Base | Total | Location |
|---------|------|-----|------|-------|----------|
| Smartsheet | SSE | 5 | 37 | 40.5 | Bengaluru |
