...
from leetcode.utils.constants import MISSING_NUMERIC, REPORTS_DIR
...
with open(f"{REPORTS_DIR}/report_{min_date}_to_{max_date}_dark_tc.md", "w") as f:
    ...
    sample_df = df[
        ["post_title", "href", "date", "company", "title", "yoe", "salary_total", "location", "post"]
    ].sort_values(by="salary_total", ascending=False)[:10]
