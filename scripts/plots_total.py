...
df = df[["href", "post_title", "date", "post", "company", "title", "yoe", "salary_total", "location"]]
...
).configure_axisBottom(labelColor="white", titleColor="white").save(f"{IMGS_DIR}/company_distribution_dark_total.png")
...
(bar + rule1_dark + rule2 + rule3).configure(background=DARK_BACKGROUND).configure_axis(grid=False).configure_axisLeft(
    ...
    f"{IMGS_DIR}/company_salary_distribution_dark_total.png"
)
...
(bar + rule1 + rule2 + rule3).configure_point(size=8).save(f"{IMGS_DIR}/title_salary_distribution_total.png")
...
alt.Chart(df[(df["Years of Experience"] != MISSING_NUMERIC)]).mark_point(color="white", size=10).encode(
    ...
    f"{IMGS_DIR}/yoe_salary_distribution_dark_total.png"
)
...
alt.Chart(
    ...
    f"{IMGS_DIR}/yoebucket_salary_distribution_dark_total.png"
)
...
alt.Chart(
    ...
    f"{IMGS_DIR}/top_companies_salary_distribution_dark_total.png"
)
