...
let globalFilterState = {
    ...
    includeInterviewExp: false  // New property to filter by interview experience
};
            ...
            <p>
                <abbr title="attribute">
                    ...
                    ${offer.interview_exp !== 'NA' ?
                        `<span class="star-icon" style="cursor: pointer; margin-left: 5px;" onclick="window.open('${offer.interview_exp}', '_blank')">${svgCode}</span>` :
                        ''}
                </abbr>
            </p>
        `;
