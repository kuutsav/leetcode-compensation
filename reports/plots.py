...
bar = alt.Chart(df).mark_bar(size=23).encode(
    x=alt.X('lpa', bin=alt.Bin(maxbins=35), title="₹ LPA"),
    y=alt.Y('count()', axis=alt.Axis(title="Count of Records")),
    color=alt.value('#F9A089'),
).properties(width=900, height=350)

rule1_dark = alt.Chart(pdf).mark_rule(color='white', strokeDash=[2, 2], size=1.5).encode(x="p75:Q")
final_bar = (bar + rule1_dark + rule2 + rule3).configure(background="#22272D")\
...
alt.Chart(df[df.company.isin(top_companies)]).mark_bar(size=25).encode(
    ...
    y=alt.Y('count()', axis=alt.Axis(title="Count of Records")),
    color=alt.value('#F9A089'),
).properties(width=900, height=350).configure(background="#22272D")\
    .configure_axisLeft(labelColor='white', titleColor='white')\
    .configure_axisBottom(labelColor='white', titleColor='white')\
...
(bar + rule1_dark + rule2 + rule3).configure(background="#22272D")\
...
(bar + rule1_dark + rule2 + rule3).configure_point(size=8).configure(background="#22272D")\
    .configure_axis(grid=False)\
    .configure_axisLeft(labelColor='white', titleColor='white')\
    .configure_axisBottom(labelColor='white', titleColor='white')\
...
).properties(width=800, height=600).configure(background="#22272D")\
    .configure_axis(grid=False)\
    .configure_axisLeft(labelColor='white', titleColor='white')\
    .configure_axisBottom(labelColor='white', titleColor='white')\
...
alt.Chart(df[(df["Years of Experience"]!=MISSING_NUMERIC)&(df['Years of Experience (bucket)']!="15+")])\
    .mark_boxplot(color="grey", size=40).encode(
        ...
        y=alt.Y('lpa', title="₹ LPA"),
        color=alt.value('#F9A089'),
).properties(width=800, height=500).configure(background="#22272D")\
    .configure_axisLeft(labelColor='white', titleColor='white')\
    .configure_axisBottom(labelColor='white', titleColor='white')\
...
.mark_boxplot(color="grey", size=10).encode(
    ...
    color='company',
    column=alt.Column('Years of Experience (bucket)'),
).properties(width=150, height=500).configure(background="#22272D")\
    .configure_axisLeft(labelColor='white', titleColor='white')\
    .configure_axisBottom(labelColor='white', titleColor='white')\
