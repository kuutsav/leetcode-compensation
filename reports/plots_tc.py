...
# load data
# df = pd.read_csv(f"{OUT_DIR}/lc_info.csv", na_filter=False)
...
final_bar = (bar + rule1_dark + rule2 + rule3).configure(background=DARK_BACKGROUND)\
...
alt.Chart(df[df.company.isin(top_companies)]).mark_bar(size=25).encode(
    ...
    y=alt.Y('count()', axis=alt.Axis(title="Count of Records")),
    color=alt.value(LIGHT_BAR),
).properties(width=900, height=350).save(f'{IMGS_DIR}/company_distribution_total.png')

alt.Chart(df[df.company.isin(top_companies)]).mark_bar(size=25).encode(
    x=alt.X('company', sort='-y', axis=alt.Axis(title=None)),
    y=alt.Y('count()', axis=alt.Axis(title="Count of Records")),
    color=alt.value(DARK_BAR),
).properties(width=900, height=350).configure(background=DARK_BACKGROUND)\
    .configure_axisLeft(labelColor='white', titleColor='white')\
    .configure_axisBottom(labelColor='white', titleColor='white')\
...
(bar + rule1 + rule2 + rule3).save(f'{IMGS_DIR}/company_salary_distribution_total.png')
...
(bar + rule1_dark + rule2 + rule3).configure(background=DARK_BACKGROUND)\
...
(bar + rule1 + rule2 + rule3).configure_point(size=8)\
    .save(f'{IMGS_DIR}/title_salary_distribution_total.png')
...
(bar + rule1_dark + rule2 + rule3).configure_point(size=8).configure(background=DARK_BACKGROUND)\
    .configure_axis(grid=False)\
    .configure_axisLeft(labelColor='white', titleColor='white')\
    .configure_axisBottom(labelColor='white', titleColor='white')\
...
).properties(width=800, height=600).save(f'{IMGS_DIR}/yoe_salary_distribution_total.png')
...
).properties(width=800, height=600).configure(background=DARK_BACKGROUND)\
    .configure_axis(grid=False)\
    .configure_axisLeft(labelColor='white', titleColor='white')\
    .configure_axisBottom(labelColor='white', titleColor='white')\
...
alt.Chart(df[(df["Years of Experience"]!=MISSING_NUMERIC)&(df['Years of Experience (bucket)']!="15+")])\
    .mark_boxplot(color="grey", size=40).encode(
        ...
        y=alt.Y('lpa', title="₹ LPA"),
        color=alt.value(LIGHT_BAR),
).properties(width=800, height=500).save(f'{IMGS_DIR}/yoebucket_salary_distribution_total.png')
...
alt.Chart(df[(df["Years of Experience"]!=MISSING_NUMERIC)&(df['Years of Experience (bucket)']!="15+")])\
    .mark_boxplot(color="grey", size=40).encode(
        ...
        y=alt.Y('lpa', title="₹ LPA"),
        color=alt.value(DARK_BAR),
).properties(width=800, height=500).configure(background=DARK_BACKGROUND)\
    .configure_axisLeft(labelColor='white', titleColor='white')\
    .configure_axisBottom(labelColor='white', titleColor='white')\
...
).properties(width=150, height=500).save(f'{IMGS_DIR}/top_companies_salary_distribution_total.png')
...
.mark_boxplot(color="grey", size=10).encode(
    ...
    color='company',
    column=alt.Column('Years of Experience (bucket)'),
).properties(width=150, height=500).configure(background=DARK_BACKGROUND)\
    .configure_legend(labelColor='white', titleColor='white')\
    .configure_axisLeft(labelColor='white', titleColor='white')\
    .configure_axisBottom(labelColor='white', titleColor='white')\
    .configure_axisTop(labelColor='white', titleColor='white')\
    .save(f'{IMGS_DIR}/top_companies_salary_distribution_dark_total.png')
